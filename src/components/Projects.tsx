...
const PROJECT_CATEGORIES: ProjectCategory[] = [
  {
    ...
    icon: Gamepad2,
    coverImage: '/public/images/pakai_4.jpg',
    subdivisions: [
      {
        name: 'Colour Block',
        ...
        photos: [
          { id: 1, title: 'Colour Block - Intro Title Screen (Ali Game Hubs)', url: '/public/images/colorblock_1.jpg', caption: 'Photo 1: Ali Game Hubs Presents Color Blocks title intro screen' },
          { id: 2, title: 'Colour Block - Mobile Puzzle Gameplay (Level 35)', url: '/public/images/colorblock_2.jpg', caption: 'Photo 2: Level 35 gameplay screen with Score 8,450 & Moves 23' },
          { id: 3, title: 'Colour Block - Free Mode Board Grid', url: '/public/images/colorblock_3.jpg', caption: 'Photo 3: Free Mode puzzle grid with Score 1260 and Restart/Menu controls' },
          { id: 4, title: 'Colour Block - Victory Trophy Screen (All 25 Levels)', url: '/public/images/color_block_4.jpg', caption: 'Photo 4: You Win! All 25 Levels Complete victory screen with trophy' }
        ]
      },
      {
        name: 'Pak AI',
        ...
        photos: [
          { id: 1, title: 'Pak AI - AI Assistant Emblem & Logo', url: '/public/images/pakai_1.jpg', caption: 'Photo 1: PakAI Logo, Brain Circuits & AI Assistant Badge' },
          { id: 2, title: 'Pak AI - Mobile App Interface & Flag Mockup', url: '/public/images/pakai_2.jpg', caption: 'Photo 2: Smartphone UI with Assalamualaikum PakAI greeting & Pakistan map' },
          { id: 3, title: 'Pak AI - Conversational Chat UI', url: '/public/images/pakai_3.jpg', caption: 'Photo 3: Dark theme chat screen with What is AI question & response' },
          { id: 4, title: 'Pak AI - Smart AI Assistant Promotional Banner', url: '/public/images/pakai_4.jpg', caption: 'Photo 4: Hero banner with Chat Now button & mobile viewport' }
        ]
      },
      {
        name: 'Learn Play',
        ...
        photos: [
          { id: 1, title: 'Learn Play - Educational Hub Logo', url: '/public/learnplay_1.jpg', caption: 'Photo 1: LearnPlay Logo with graduation cap & Learn Play Grow slogan' },
          { id: 2, title: 'Learn Play - Tablet Learning Dashboard', url: '/public/images/learnplay_2.jpg', caption: 'Photo 2: English, Maths, Science & Quiz modules on tablet UI' },
          { id: 3, title: 'Learn Play - Student Hero Banner', url: '/public/learnplay_3.jpg', caption: 'Photo 3: Learn Today, Lead Tomorrow banner with Start Learning button' },
          { id: 4, title: 'Learn Play - Quiz Victory Score Screen', url: '/public/images/learnplay_4.jpg', caption: 'Photo 4: Well Done victory modal with 3 gold stars & Score 8/10' }
        ]
      }
    ]
  },
  {
    ...
    icon: Palette,
    coverImage: '/public/images/pixelforge_studio.jpg',
    subdivisions: [
      {
        name: 'Logo Design',
        badge: 'Division 1 • 4 Photos',
        ...
        photos: [
          { id: 1, title: 'Pixel Forge Studio - Creative Design Workspace', url: '/public/images/pixelforge_studio_1.jpg', caption: 'Photo 1: Pixel Forge Studio monitor workspace, drawing tablet & color swatches' },
          { id: 2, title: 'Logo Design - Stewerds Family Gold Crown Emblem', url: '/public/images/logo_design_2.jpg', caption: 'Photo 2: Royal gold family logo on dark wood background' },
          { id: 3, title: 'Logo Design - Luxury Gold CL Ring Logo', url: '/public/images/logo_design_3.jpg', caption: 'Photo 3: Metallic gold ring emblem with script typography' },
          { id: 4, title: 'Logo Design - Gold CL Cream Badge Logo', url: '/public/images/logo_design_4.jpg', caption: 'Photo 4: Premium gold monogram script on cream circular badge' }
        ]
      },
      {
        name: 'Visiting Card',
        ...
        photos: [
          { id: 1, title: 'Muhammad Ali - Creative Developer Business Card', url: '/public/images/visiting_card_1.jpg', caption: 'Photo 1: Executive double-sided blue & black design with contact details & website link' },
          { id: 2, title: 'Jhan Mobile Hub - Luxury Gold Partner Card', url: '/public/images/visiting_card_2.jpg', caption: 'Photo 2: Gold & black mobile shop business card with smartphone repair services list & QR code' },
          { id: 3, title: 'Anshu Mobile Shop - Tech Blue Business Card', url: '/public/images/visiting_card_3.jpg', caption: 'Photo 3: Futuristic tech blue card layout with WhatsApp chat QR code & service guide' },
          { id: 4, title: 'Mobile Zone - CEO Faizan Amjad Business Card', url: '/public/images/visiting_card_4.jpg', caption: 'Photo 4: High-contrast orange & dark geometric corporate card with CEO details & address' }
        ]
      },
      {
        name: 'Banner',
        ...
        photos: [
          { id: 1, title: 'Aala Hazrat Muradabadi Biryani Banner', url: '/public/images/banner_1.jpg', caption: 'Photo 1: Aala Hazrat Muradabadi Biryani restaurant promotional banner' },
          { id: 2, title: 'Travel The World Explorer Banner', url: '/public/images/banner_2.jpg', caption: 'Photo 2: Travel The World adventure banner with sea & mountain scenery' },
          { id: 3, title: 'Special Coffee Shop 30% Discount Banner', url: '/public/images/banner_3.jpg', caption: 'Photo 3: Special Coffee Shop 30% discount promotional banner' },
          { id: 4, title: 'Special Discount Food Shop Banner', url: '/public/images/banner_4.jpg', caption: 'Photo 4: Special Discount Food Shop promotional header banner with pizza frames' }
        ]
      }
    ]
  },
